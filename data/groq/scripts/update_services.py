#!/usr/bin/env python3
"""
Simplified update_services.py for Groq using unitysvc_services data builders.
...
class ModelExtractor:
    ...
    def determine_service_type(self, model_id: str) -> str:
        ...
        if any(kw in model_lower for kw in ["tts", "speech"]):
    ...
    def get_code_examples(self, model_id: str) -> list[tuple[str, str, str]]:
        ...
        if "tts" in model_lower:
            return [
                ("Python code example", "../../docs/code-example-tts.py.j2", "python"),
                ("JavaScript code example", "../../docs/code-example-tts.js.j2", "javascript"),
                ("cURL code example", "../../docs/code-example-tts.sh.j2", "bash"),
            ]
        if "guard" in model_lower:
            return [
                ("Python code example", "../../docs/code-example-guard.py.j2", "python"),
                ("JavaScript code example", "../../docs/code-example-guard.js.j2", "javascript"),
                ("cURL code example", "../../docs/code-example-guard.sh.j2", "bash"),
            ]
        return [
    ...
    def build_listing(self, model_id: str) -> ListingDataBuilder:
        ...
        builder.set_raw("service_options", {"default_parameters": {"api_key": "${ secrets.GROQ_API_KEY }"}})
